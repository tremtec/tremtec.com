    ...
    <main class="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-blue-50 to-blue-100">
      ...
      <section class="bg-white p-6 rounded-lg shadow-md max-w-4xl">
        ...
        <p class="text-lg text-gray-700 mb-6">
          ...
          enabling people to achieve their fullest potential. Our commitment to
          open-source principles ensures that our innovations are shared freely,
          fostering a community of collaboration and growth.
        </p>
