...
export const siteTexts = {
  ...
  contactSubTitle:
    "Need details about our Business plan? Wanna take a coffee and see how we can bring value to your busines? Let us know.",
  mailTo: "mailto:root@tremtec.com",
  inputs: {
    email: { label: "Your email", placeholder: "name@tremtec.com" },
    message: { label: "Your message", placeholder: "Leave a message" },
    subject: {
      label: "Subject",
